...
```json
"features": {
    "ghcr.io/braechnov/features/java:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/braechnov/features/blob/main/src/java2/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
