...
# opentf, tflint, and TFGrunt (terraform)

Installs the opentf CLI and optionally TFLint and Terragrunt. Auto-detects latest version and installs needed dependencies.

## Example Usage

```json
"features": {
    "ghcr.io/devcontainers/features/opentf:1": {}
}
```
...
|-----|-----|-----|-----|
| version | opentf version | string | latest |
